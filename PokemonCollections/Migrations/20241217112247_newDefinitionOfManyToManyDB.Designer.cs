...
namespace PokemonCollections.Migrations
{
    ...
    [Migration("20241217112247_newDefinitionOfManyToManyDB")]
    partial class newDefinitionOfManyToManyDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokemonCollections.Models.CardCollection", b =>
                {
                    b.HasOne("PokemonCollections.Models.PokemonCard", "PokemonCard")
                        .WithMany()
                        .HasForeignKey("PokemonCardid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PokemonCollections.Models.PokemonCollection", "PokemonCollection")
                        .WithMany()
